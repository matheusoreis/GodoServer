/*
  ...
  - You are about to drop the column `directionX` on the `Characters` table. All the data in the column will be lost.
  - You are about to drop the column `directionY` on the `Characters` table. All the data in the column will be lost.
